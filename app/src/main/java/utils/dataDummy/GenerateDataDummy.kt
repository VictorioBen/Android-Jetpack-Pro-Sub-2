...
object GenerateDataDummy {
    ...
    fun generateDummyDetailMovies(): List<MovieDetailEntity> {
        val movieDetail = ArrayList<MovieDetailEntity>()
    ...
    fun generateDummyTvDetail(): List<TvDetailEntity> {
        val tvShow = ArrayList<TvDetailEntity>()
